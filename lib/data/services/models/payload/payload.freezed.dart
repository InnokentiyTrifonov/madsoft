...
/// @nodoc
mixin _$Payload {
  List<Something> get payload => throw _privateConstructorUsedError;
...
abstract class $PayloadCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Something> payload});
}
...
class _$PayloadImpl implements _Payload {
  const _$PayloadImpl({required final List<Something> payload})
      : _payload = payload;

  factory _$PayloadImpl.fromJson(Map<String, dynamic> json) =>
      _$$PayloadImplFromJson(json);

  final List<Something> _payload;
  @override
  List<Something> get payload {
...
abstract class _Payload implements Payload {
  const factory _Payload({required final List<Something> payload}) =
      _$PayloadImpl;
